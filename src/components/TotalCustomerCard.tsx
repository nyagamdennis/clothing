import { ArrowTrendingDownIcon, ArrowTrendingUpIcon, EllipsisVerticalIcon, UsersIcon } from '@heroicons/react/24/outline';
...
const TotalCustomerCard: React.FC<TotalOrdersCardsData> = ({ ordersDiff, orderIncreased, OrderPercentageDifference, thisMonthsOrders }) => {
  return (
    <div className=' cursor-pointer bg-white shadow-md shadow-slate-200 rounded-lg overflow-hidden p-3 flex flex-col justify-between space-y-7'>
      <div className='flex justify-between'>
        <div className='flex space-x-2'>
          ...
          <h4 className=' font-semibold text-gray-500'>New Customers</h4>
        </div>
